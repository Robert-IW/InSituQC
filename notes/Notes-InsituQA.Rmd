...
For the R package 'ecp' the only assumptions placed on distributions are that the absolute αth moment exists, for some α ∈ (0, 2], and that observations are *independent over time*. Autocorrelations can lead to false positives.
